...
val Duotone.VaultDuotone: ImageVector
    get() {
        if (_VaultDuotone != null) {
            return _VaultDuotone!!
        }
        _VaultDuotone =
            ImageVector
                .Builder(
                    ...
                    path(
                        ...
                        arcTo(40f, 40f, 0f, isMoreThanHalf = false, isPositiveArc = true, 152f, 168f)
                        close()
                    }
                    path(
...
private var _VaultDuotone: ImageVector? = null
