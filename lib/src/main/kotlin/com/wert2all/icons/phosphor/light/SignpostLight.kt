...
val Phosphor.Light.SignpostLight: ImageVector
    get() {
        if (_SignpostLight != null) {
            return _SignpostLight!!
        }
        _SignpostLight =
            ImageVector
                .Builder(
                    name = "Light.SignpostLight",
                    defaultWidth = 256.dp,
...
private var _SignpostLight: ImageVector? = null
