...
val Phosphor.Bold.FilePngBold: ImageVector
    get() {
        if (_FilePngBold != null) {
            return _FilePngBold!!
        }
        _FilePngBold =
            ImageVector
                .Builder(
                    name = "Bold.FilePngBold",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcTo(22.12f, 22.12f, 0f, isMoreThanHalf = false, isPositiveArc = true, 204f, 208f)
...
private var _FilePngBold: ImageVector? = null
