...
val Phosphor.Thin.BackspaceThin: ImageVector
    get() {
        if (_BackspaceThin != null) {
            return _BackspaceThin!!
        }
        _BackspaceThin =
            ImageVector
                .Builder(
                    name = "Thin.BackspaceThin",
                    defaultWidth = 256.dp,
...
private var _BackspaceThin: ImageVector? = null
