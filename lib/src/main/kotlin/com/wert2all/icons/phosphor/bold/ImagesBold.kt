...
val Phosphor.Bold.ImagesBold: ImageVector
    get() {
        if (_ImagesBold != null) {
            return _ImagesBold!!
        }
            ...
            ImageVector
                .Builder(
                    ...
                    path(
                        ...
                        lineTo(72f, 56f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 80f, 48f)
                        close()
                    }
                    path(
                        stroke = SolidColor(Color(0xFF000000)),
...
private var _ImagesBold: ImageVector? = null
