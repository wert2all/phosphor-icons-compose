...
val Phosphor.Light.PlayPauseLight: ImageVector
    get() {
        if (_PlayPauseLight != null) {
            return _PlayPauseLight!!
        }
        _PlayPauseLight =
            ImageVector
                .Builder(
                    name = "Light.PlayPauseLight",
                    defaultWidth = 256.dp,
...
private var _PlayPauseLight: ImageVector? = null
