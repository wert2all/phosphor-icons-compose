...
val Phosphor.Bold.LastfmLogoBold: ImageVector
    get() {
        if (_LastfmLogoBold != null) {
            return _LastfmLogoBold!!
        }
        _LastfmLogoBold =
            ImageVector
                .Builder(
                    name = "Bold.LastfmLogoBold",
                    defaultWidth = 256.dp,
...
private var _LastfmLogoBold: ImageVector? = null
