...
val Phosphor.Thin.PhonePauseThin: ImageVector
    get() {
        if (_PhonePauseThin != null) {
            return _PhonePauseThin!!
        }
        _PhonePauseThin =
            ImageVector
                .Builder(
                    name = "Thin.PhonePauseThin",
                    defaultWidth = 256.dp,
...
private var _PhonePauseThin: ImageVector? = null
