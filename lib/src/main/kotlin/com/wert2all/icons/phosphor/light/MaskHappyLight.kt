...
val Phosphor.Light.MaskHappyLight: ImageVector
    get() {
        if (_MaskHappyLight != null) {
            return _MaskHappyLight!!
        }
        _MaskHappyLight =
            ImageVector
                .Builder(
                    name = "Light.MaskHappyLight",
                    defaultWidth = 256.dp,
...
private var _MaskHappyLight: ImageVector? = null
