...
val Phosphor.Light.ChatCircleLight: ImageVector
    get() {
        if (_ChatCircleLight != null) {
            return _ChatCircleLight!!
        }
        _ChatCircleLight =
            ImageVector
                .Builder(
                    name = "Light.ChatCircleLight",
                    defaultWidth = 256.dp,
...
private var _ChatCircleLight: ImageVector? = null
