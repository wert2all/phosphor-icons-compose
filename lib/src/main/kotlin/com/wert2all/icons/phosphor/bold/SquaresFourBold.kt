...
val Phosphor.Bold.SquaresFourBold: ImageVector
    get() {
        if (_SquaresFourBold != null) {
            return _SquaresFourBold!!
        }
        _SquaresFourBold =
            ImageVector
                .Builder(
                    name = "Bold.SquaresFourBold",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(156f, 148f)
                        lineTo(200f, 148f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 208f, 156f)
                        lineTo(208f, 200f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 200f, 208f)
                        lineTo(156f, 208f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 148f, 200f)
                        lineTo(148f, 156f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 156f, 148f)
                        close()
                    }
                }.build()
...
private var _SquaresFourBold: ImageVector? = null
