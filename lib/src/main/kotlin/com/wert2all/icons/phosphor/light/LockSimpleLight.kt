...
val Phosphor.Light.LockSimpleLight: ImageVector
    get() {
        if (_LockSimpleLight != null) {
            return _LockSimpleLight!!
        }
        _LockSimpleLight =
            ImageVector
                .Builder(
                    name = "Light.LockSimpleLight",
                    defaultWidth = 256.dp,
...
private var _LockSimpleLight: ImageVector? = null
