...
val Duotone.VirusDuotone: ImageVector
    get() {
        if (_VirusDuotone != null) {
            return _VirusDuotone!!
        }
        _VirusDuotone =
            ImageVector
                .Builder(
                    ...
                    path(
                        ...
                        arcTo(88f, 88f, 0f, isMoreThanHalf = false, isPositiveArc = false, 128f, 40f)
                        close()
                        moveTo(108f, 128f)
                        arcToRelative(20f, 20f, 0f, isMoreThanHalf = true, isPositiveArc = true, 20f, -20f)
                        arcTo(20f, 20f, 0f, isMoreThanHalf = false, isPositiveArc = true, 108f, 128f)
                        close()
                    }
                    path(
...
private var _VirusDuotone: ImageVector? = null
