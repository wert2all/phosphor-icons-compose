...
val Phosphor.Bold.PhoneDisconnectBold: ImageVector
    get() {
        if (_PhoneDisconnectBold != null) {
            return _PhoneDisconnectBold!!
        }
        _PhoneDisconnectBold =
            ImageVector
                .Builder(
                    name = "Bold.PhoneDisconnectBold",
                    defaultWidth = 256.dp,
...
private var _PhoneDisconnectBold: ImageVector? = null
