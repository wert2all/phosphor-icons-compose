...
val Fill.ChatCenteredDotsFill: ImageVector
    get() {
        if (_ChatCenteredDotsFill != null) {
            return _ChatCenteredDotsFill!!
        }
        _ChatCenteredDotsFill =
            ImageVector
                .Builder(
                    name = "ChatCenteredDotsFill",
                    defaultWidth = 256.dp,
                    ...
                    path(fill = SolidColor(Color(0xFF000000))) {
                        ...
                        arcTo(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, 84f, 132f)
                        close()
                        moveTo(128f, 132f)
                        arcToRelative(12f, 12f, 0f, isMoreThanHalf = true, isPositiveArc = true, 12f, -12f)
                        ...
                        moveTo(172f, 132f)
                        arcToRelative(12f, 12f, 0f, isMoreThanHalf = true, isPositiveArc = true, 12f, -12f)
                        arcTo(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, 172f, 132f)
                        close()
                    }
                }.build()
...
private var _ChatCenteredDotsFill: ImageVector? = null
