...
val Phosphor.Thin.FolderMinusThin: ImageVector
    get() {
        if (_FolderMinusThin != null) {
            return _FolderMinusThin!!
        }
        _FolderMinusThin =
            ImageVector
                .Builder(
                    name = "Thin.FolderMinusThin",
                    defaultWidth = 256.dp,
...
private var _FolderMinusThin: ImageVector? = null
