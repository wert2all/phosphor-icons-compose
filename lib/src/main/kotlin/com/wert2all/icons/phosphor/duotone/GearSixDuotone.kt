...
val Phosphor.Duotone.GearSixDuotone: ImageVector
    get() {
        if (_GearSixDuotone != null) {
            return _GearSixDuotone!!
        }
        _GearSixDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.GearSixDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(230.1f, 108.76f)
                        lineTo(198.25f, 90.62f)
                        curveToRelative(-0.64f, -1.16f, -1.31f, -2.29f, -2f, -3.41f)
                        lineToRelative(-0.12f, -36f)
                        arcTo(104.61f, 104.61f, 0f, isMoreThanHalf = false, isPositiveArc = false, 162f, 32f)
                        lineTo(130f, 49.89f)
                        curveToRelative(-1.34f, 0f, -2.69f, 0f, -4f, 0f)
                        lineTo(94f, 32f)
                        arcTo(104.58f, 104.58f, 0f, isMoreThanHalf = false, isPositiveArc = false, 59.89f, 51.25f)
                        lineToRelative(-0.16f, 36f)
                        curveToRelative(-0.7f, 1.12f, -1.37f, 2.26f, -2f, 3.41f)
                        lineToRelative(-31.84f, 18.1f)
                        arcToRelative(99.15f, 99.15f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, 38.46f)
                        lineToRelative(31.85f, 18.14f)
                        curveToRelative(0.64f, 1.16f, 1.31f, 2.29f, 2f, 3.41f)
                        lineToRelative(0.12f, 36f)
                        arcTo(104.61f, 104.61f, 0f, isMoreThanHalf = false, isPositiveArc = false, 94f, 224f)
                        lineToRelative(32f, -17.87f)
                        curveToRelative(1.34f, 0f, 2.69f, 0f, 4f, 0f)
                        lineTo(162f, 224f)
                        arcToRelative(
                            104.58f,
                        ...
                        curveToRelative(0.7f, -1.12f, 1.37f, -2.26f, 2f, -3.41f)
                        lineToRelative(31.84f, -18.1f)
                        arcTo(99.15f, 99.15f, 0f, isMoreThanHalf = false, isPositiveArc = false, 230.1f, 108.76f)
                        close()
                        moveTo(128f, 168f)
...
private var _GearSixDuotone: ImageVector? = null
