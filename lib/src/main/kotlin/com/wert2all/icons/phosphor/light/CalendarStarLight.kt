...
val Phosphor.Light.CalendarStarLight: ImageVector
    get() {
        if (_CalendarStarLight != null) {
            return _CalendarStarLight!!
        }
        _CalendarStarLight =
            ImageVector
                .Builder(
                    name = "Light.CalendarStarLight",
                    defaultWidth = 256.dp,
...
private var _CalendarStarLight: ImageVector? = null
