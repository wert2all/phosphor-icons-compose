...
val Phosphor.Thin.CalendarMinusThin: ImageVector
    get() {
        if (_CalendarMinusThin != null) {
            return _CalendarMinusThin!!
        }
        _CalendarMinusThin =
            ImageVector
                .Builder(
                    name = "Thin.CalendarMinusThin",
                    defaultWidth = 256.dp,
...
private var _CalendarMinusThin: ImageVector? = null
