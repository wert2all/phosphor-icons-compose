...
val Phosphor.Light.EarSlashLight: ImageVector
    get() {
        if (_EarSlashLight != null) {
            return _EarSlashLight!!
        }
        _EarSlashLight =
            ImageVector
                .Builder(
                    name = "Light.EarSlashLight",
                    defaultWidth = 256.dp,
...
private var _EarSlashLight: ImageVector? = null
