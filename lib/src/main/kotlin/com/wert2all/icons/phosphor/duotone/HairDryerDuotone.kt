...
val Phosphor.Duotone.HairDryerDuotone: ImageVector
    get() {
        if (_HairDryerDuotone != null) {
            return _HairDryerDuotone!!
        }
        _HairDryerDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.HairDryerDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = false, 24f, 62.78f)
                        verticalLineToRelative(50.44f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = false, 6.68f, 7.89f)
                        lineTo(168f, 144f)
...
private var _HairDryerDuotone: ImageVector? = null
