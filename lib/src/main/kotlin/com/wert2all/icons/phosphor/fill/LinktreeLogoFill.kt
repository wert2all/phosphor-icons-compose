...
val Phosphor.Fill.LinktreeLogoFill: ImageVector
    get() {
        if (_LinktreeLogoFill != null) {
            return _LinktreeLogoFill!!
        }
        _LinktreeLogoFill =
            ImageVector
                .Builder(
                    name = "Fill.LinktreeLogoFill",
                    defaultWidth = 256.dp,
                    ...
                    path(fill = SolidColor(Color.Black)) {
                        ...
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 93.66f, 66.34f)
                        lineTo(120f, 92.69f)
                        lineTo(120f, 56f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 16f, 0f)
                        lineTo(136f, 92.69f)
...
private var _LinktreeLogoFill: ImageVector? = null
