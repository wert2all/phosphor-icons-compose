...
val Phosphor.Light.PencilLineLight: ImageVector
    get() {
        if (_PencilLineLight != null) {
            return _PencilLineLight!!
        }
        _PencilLineLight =
            ImageVector
                .Builder(
                    name = "Light.PencilLineLight",
                    defaultWidth = 256.dp,
...
private var _PencilLineLight: ImageVector? = null
