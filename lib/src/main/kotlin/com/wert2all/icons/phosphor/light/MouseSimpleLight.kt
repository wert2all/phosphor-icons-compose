...
val Phosphor.Light.MouseSimpleLight: ImageVector
    get() {
        if (_MouseSimpleLight != null) {
            return _MouseSimpleLight!!
        }
        _MouseSimpleLight =
            ImageVector
                .Builder(
                    name = "Light.MouseSimpleLight",
                    defaultWidth = 256.dp,
...
private var _MouseSimpleLight: ImageVector? = null
