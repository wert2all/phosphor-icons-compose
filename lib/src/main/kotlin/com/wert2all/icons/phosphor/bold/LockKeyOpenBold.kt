...
val Phosphor.Bold.LockKeyOpenBold: ImageVector
    get() {
        if (_LockKeyOpenBold != null) {
            return _LockKeyOpenBold!!
        }
        _LockKeyOpenBold =
            ImageVector
                .Builder(
                    name = "Bold.LockKeyOpenBold",
                    defaultWidth = 256.dp,
...
private var _LockKeyOpenBold: ImageVector? = null
