...
val Phosphor.Light.DiceFiveLight: ImageVector
    get() {
        if (_DiceFiveLight != null) {
            return _DiceFiveLight!!
        }
        _DiceFiveLight =
            ImageVector
                .Builder(
                    name = "Light.DiceFiveLight",
                    defaultWidth = 256.dp,
...
private var _DiceFiveLight: ImageVector? = null
