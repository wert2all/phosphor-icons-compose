...
val Phosphor.Light.HandArrowUpLight: ImageVector
    get() {
        if (_HandArrowUpLight != null) {
            return _HandArrowUpLight!!
        }
        _HandArrowUpLight =
            ImageVector
                .Builder(
                    name = "Light.HandArrowUpLight",
                    defaultWidth = 256.dp,
...
private var _HandArrowUpLight: ImageVector? = null
