...
val Light.PenNibStraightLight: ImageVector
    get() {
        if (_PenNibStraightLight != null) {
            return _PenNibStraightLight!!
        }
        _PenNibStraightLight =
            ImageVector
                .Builder(
                    name = "PenNibStraightLight",
                    defaultWidth = 256.dp,
...
private var _PenNibStraightLight: ImageVector? = null
