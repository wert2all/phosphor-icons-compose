...
val Phosphor.Duotone.CalendarDuotone: ImageVector
    get() {
        if (_CalendarDuotone != null) {
            return _CalendarDuotone!!
        }
        _CalendarDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.CalendarDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(138.14f, 128f)
                        arcToRelative(16f, 16f, 0f, isMoreThanHalf = true, isPositiveArc = true, 26.64f, 17.63f)
                        lineTo(136f, 184f)
...
private var _CalendarDuotone: ImageVector? = null
