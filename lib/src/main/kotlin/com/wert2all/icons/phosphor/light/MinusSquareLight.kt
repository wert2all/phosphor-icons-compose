...
val Phosphor.Light.MinusSquareLight: ImageVector
    get() {
        if (_MinusSquareLight != null) {
            return _MinusSquareLight!!
        }
        _MinusSquareLight =
            ImageVector
                .Builder(
                    name = "Light.MinusSquareLight",
                    defaultWidth = 256.dp,
...
private var _MinusSquareLight: ImageVector? = null
