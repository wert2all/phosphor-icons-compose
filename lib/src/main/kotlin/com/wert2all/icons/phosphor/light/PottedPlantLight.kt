...
val Phosphor.Light.PottedPlantLight: ImageVector
    get() {
        if (_PottedPlantLight != null) {
            return _PottedPlantLight!!
        }
        _PottedPlantLight =
            ImageVector
                .Builder(
                    name = "Light.PottedPlantLight",
                    defaultWidth = 256.dp,
...
private var _PottedPlantLight: ImageVector? = null
