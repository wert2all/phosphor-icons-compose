...
val Phosphor.Duotone.CommandDuotone: ImageVector
    get() {
        if (_CommandDuotone != null) {
            return _CommandDuotone!!
        }
        _CommandDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.CommandDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        verticalLineTo(76f)
                        arcTo(28f, 28f, 0f, isMoreThanHalf = false, isPositiveArc = true, 180f, 48f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color.Black),
...
private var _CommandDuotone: ImageVector? = null
