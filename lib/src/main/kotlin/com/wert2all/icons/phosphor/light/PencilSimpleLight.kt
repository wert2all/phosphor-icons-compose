...
val Phosphor.Light.PencilSimpleLight: ImageVector
    get() {
        if (_PencilSimpleLight != null) {
            return _PencilSimpleLight!!
        }
        _PencilSimpleLight =
            ImageVector
                .Builder(
                    name = "Light.PencilSimpleLight",
                    defaultWidth = 256.dp,
...
private var _PencilSimpleLight: ImageVector? = null
