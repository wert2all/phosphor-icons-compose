...
val Phosphor.Light.PhoneIncomingLight: ImageVector
    get() {
        if (_PhoneIncomingLight != null) {
            return _PhoneIncomingLight!!
        }
        _PhoneIncomingLight =
            ImageVector
                .Builder(
                    name = "Light.PhoneIncomingLight",
                    defaultWidth = 256.dp,
...
private var _PhoneIncomingLight: ImageVector? = null
