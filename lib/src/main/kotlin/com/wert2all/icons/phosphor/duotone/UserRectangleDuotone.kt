...
val Duotone.UserRectangleDuotone: ImageVector
    get() {
        if (_UserRectangleDuotone != null) {
            return _UserRectangleDuotone!!
        }
        _UserRectangleDuotone =
            ImageVector
                .Builder(
                    name = "UserRectangleDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcToRelative(72f, 72f, 0f, isMoreThanHalf = false, isPositiveArc = true, 67.9f, 48f)
                    ...
                    path(
                        ...
                        moveTo(60.1f, 208f)
                        arcToRelative(72f, 72f, 0f, isMoreThanHalf = false, isPositiveArc = true, 135.8f, 0f)
                    }
                }.build()
...
private var _UserRectangleDuotone: ImageVector? = null
