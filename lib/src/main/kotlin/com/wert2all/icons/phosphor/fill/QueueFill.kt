...
val Phosphor.Fill.QueueFill: ImageVector
    get() {
        if (_QueueFill != null) {
            return _QueueFill!!
        }
            ...
            ImageVector
                .Builder(
                    ...
                    path(fill = SolidColor(Color.Black)) {
                        ...
                        lineTo(136f, 120f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 12.44f, -6.66f)
...
private var _QueueFill: ImageVector? = null
