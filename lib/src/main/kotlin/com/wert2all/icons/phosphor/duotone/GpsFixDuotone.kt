...
val Duotone.GpsFixDuotone: ImageVector
    get() {
        if (_GpsFixDuotone != null) {
            return _GpsFixDuotone!!
        }
        _GpsFixDuotone =
            ImageVector
                .Builder(
                    ...
                    path(
                        ...
                        arcTo(80f, 80f, 0f, isMoreThanHalf = false, isPositiveArc = false, 128f, 48f)
                        close()
                        moveTo(128f, 160f)
...
private var _GpsFixDuotone: ImageVector? = null
