...
val Phosphor.Light.PaperclipLight: ImageVector
    get() {
        if (_PaperclipLight != null) {
            return _PaperclipLight!!
        }
        _PaperclipLight =
            ImageVector
                .Builder(
                    name = "Light.PaperclipLight",
                    defaultWidth = 256.dp,
...
private var _PaperclipLight: ImageVector? = null
