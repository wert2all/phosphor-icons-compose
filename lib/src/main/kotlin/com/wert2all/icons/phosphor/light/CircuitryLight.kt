...
val Phosphor.Light.CircuitryLight: ImageVector
    get() {
        if (_CircuitryLight != null) {
            return _CircuitryLight!!
        }
        _CircuitryLight =
            ImageVector
                .Builder(
                    name = "Light.CircuitryLight",
                    defaultWidth = 256.dp,
...
private var _CircuitryLight: ImageVector? = null
