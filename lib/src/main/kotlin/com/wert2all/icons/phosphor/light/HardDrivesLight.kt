...
val Phosphor.Light.HardDrivesLight: ImageVector
    get() {
        if (_HardDrivesLight != null) {
            return _HardDrivesLight!!
        }
        _HardDrivesLight =
            ImageVector
                .Builder(
                    name = "Light.HardDrivesLight",
                    defaultWidth = 256.dp,
...
private var _HardDrivesLight: ImageVector? = null
