...
val Phosphor.Light.CalendarPlusLight: ImageVector
    get() {
        if (_CalendarPlusLight != null) {
            return _CalendarPlusLight!!
        }
        _CalendarPlusLight =
            ImageVector
                .Builder(
                    name = "Light.CalendarPlusLight",
                    defaultWidth = 256.dp,
...
private var _CalendarPlusLight: ImageVector? = null
