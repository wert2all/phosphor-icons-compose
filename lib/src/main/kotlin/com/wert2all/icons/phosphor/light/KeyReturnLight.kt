...
val Phosphor.Light.KeyReturnLight: ImageVector
    get() {
        if (_KeyReturnLight != null) {
            return _KeyReturnLight!!
        }
        _KeyReturnLight =
            ImageVector
                .Builder(
                    name = "Light.KeyReturnLight",
                    defaultWidth = 256.dp,
...
private var _KeyReturnLight: ImageVector? = null
