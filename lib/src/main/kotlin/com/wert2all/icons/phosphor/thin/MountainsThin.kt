...
val Phosphor.Thin.MountainsThin: ImageVector
    get() {
        if (_MountainsThin != null) {
            return _MountainsThin!!
        }
        _MountainsThin =
            ImageVector
                .Builder(
                    name = "Thin.MountainsThin",
                    defaultWidth = 256.dp,
...
private var _MountainsThin: ImageVector? = null
