...
val Phosphor.Light.CardholderLight: ImageVector
    get() {
        if (_CardholderLight != null) {
            return _CardholderLight!!
        }
        _CardholderLight =
            ImageVector
                .Builder(
                    name = "Light.CardholderLight",
                    defaultWidth = 256.dp,
...
private var _CardholderLight: ImageVector? = null
