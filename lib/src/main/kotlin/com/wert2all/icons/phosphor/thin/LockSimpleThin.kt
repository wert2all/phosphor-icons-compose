...
val Phosphor.Thin.LockSimpleThin: ImageVector
    get() {
        if (_LockSimpleThin != null) {
            return _LockSimpleThin!!
        }
        _LockSimpleThin =
            ImageVector
                .Builder(
                    name = "Thin.LockSimpleThin",
                    defaultWidth = 256.dp,
...
private var _LockSimpleThin: ImageVector? = null
