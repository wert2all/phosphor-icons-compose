...
val Duotone.FlowerLotusDuotone: ImageVector
    get() {
        if (_FlowerLotusDuotone != null) {
            return _FlowerLotusDuotone!!
        }
        _FlowerLotusDuotone =
            ImageVector
                .Builder(
                    name = "FlowerLotusDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        curveToRelative(-3f, 9.27f, -6.58f, 27.83f, 1f, 51.71f)
                        ...
                        curveTo(128f, 200f, 88f, 178f, 88f, 119.18f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000)),
                        ...
                        horizontalLineToRelative(0f)
                        curveToRelative(7.63f, -23.88f, 4f, -42.44f, 1f, -51.71f)
                        arcTo(8.2f, 8.2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 195f, 64.18f)
                        curveToRelative(-7.52f, 1.61f, -20.24f, 5.8f, -33.56f, 16.62f)
                        verticalLineToRelative(0f)
                        arcTo(108.49f, 108.49f, 0f, isMoreThanHalf = false, isPositiveArc = true, 168f, 119.18f)
                        curveTo(168f, 178f, 128f, 200f, 128f, 200f)
                        curveToRelative(15.37f, 0f, 40.77f, -0.18f, 70f, -17.64f)
                        reflectiveCurveToRelative(38.69f, -39.34f, 41.72f, -50.54f)
                        arcTo(7.94f, 7.94f, 0f, isMoreThanHalf = false, isPositiveArc = false, 234.26f, 122f)
                        close()
                    }
                    path(
...
private var _FlowerLotusDuotone: ImageVector? = null
