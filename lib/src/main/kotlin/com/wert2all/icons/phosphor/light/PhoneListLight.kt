...
val Phosphor.Light.PhoneListLight: ImageVector
    get() {
        if (_PhoneListLight != null) {
            return _PhoneListLight!!
        }
        _PhoneListLight =
            ImageVector
                .Builder(
                    name = "Light.PhoneListLight",
                    defaultWidth = 256.dp,
...
private var _PhoneListLight: ImageVector? = null
