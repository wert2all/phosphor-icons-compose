...
val Phosphor.Light.PipeWrenchLight: ImageVector
    get() {
        if (_PipeWrenchLight != null) {
            return _PipeWrenchLight!!
        }
        _PipeWrenchLight =
            ImageVector
                .Builder(
                    name = "Light.PipeWrenchLight",
                    defaultWidth = 256.dp,
...
private var _PipeWrenchLight: ImageVector? = null
