...
val Phosphor.Light.MonitorPlayLight: ImageVector
    get() {
        if (_MonitorPlayLight != null) {
            return _MonitorPlayLight!!
        }
        _MonitorPlayLight =
            ImageVector
                .Builder(
                    name = "Light.MonitorPlayLight",
                    defaultWidth = 256.dp,
...
private var _MonitorPlayLight: ImageVector? = null
