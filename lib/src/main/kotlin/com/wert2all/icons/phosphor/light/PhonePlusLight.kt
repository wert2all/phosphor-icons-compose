...
val Phosphor.Light.PhonePlusLight: ImageVector
    get() {
        if (_PhonePlusLight != null) {
            return _PhonePlusLight!!
        }
        _PhonePlusLight =
            ImageVector
                .Builder(
                    name = "Light.PhonePlusLight",
                    defaultWidth = 256.dp,
...
private var _PhonePlusLight: ImageVector? = null
