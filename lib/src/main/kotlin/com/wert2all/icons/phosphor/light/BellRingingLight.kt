...
val Phosphor.Light.BellRingingLight: ImageVector
    get() {
        if (_BellRingingLight != null) {
            return _BellRingingLight!!
        }
        _BellRingingLight =
            ImageVector
                .Builder(
                    name = "Light.BellRingingLight",
                    defaultWidth = 256.dp,
...
private var _BellRingingLight: ImageVector? = null
