...
val Phosphor.Light.TrafficConeLight: ImageVector
    get() {
        if (_TrafficConeLight != null) {
            return _TrafficConeLight!!
        }
        _TrafficConeLight =
            ImageVector
                .Builder(
                    name = "Light.TrafficConeLight",
                    defaultWidth = 256.dp,
...
private var _TrafficConeLight: ImageVector? = null
