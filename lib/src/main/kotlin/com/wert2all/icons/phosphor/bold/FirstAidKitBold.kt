...
val Phosphor.Bold.FirstAidKitBold: ImageVector
    get() {
        if (_FirstAidKitBold != null) {
            return _FirstAidKitBold!!
        }
        _FirstAidKitBold =
            ImageVector
                .Builder(
                    name = "Bold.FirstAidKitBold",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcTo(16f, 16f, 0f, isMoreThanHalf = false, isPositiveArc = false, 88f, 44f)
                        verticalLineTo(64f)
                    }
                    path(
                        stroke = SolidColor(Color(0xFF000000)),
...
private var _FirstAidKitBold: ImageVector? = null
