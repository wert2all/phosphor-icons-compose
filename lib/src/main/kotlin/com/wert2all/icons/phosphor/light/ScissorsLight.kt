...
val Phosphor.Light.ScissorsLight: ImageVector
    get() {
        if (_ScissorsLight != null) {
            return _ScissorsLight!!
        }
        _ScissorsLight =
            ImageVector
                .Builder(
                    name = "Light.ScissorsLight",
                    defaultWidth = 256.dp,
...
private var _ScissorsLight: ImageVector? = null
