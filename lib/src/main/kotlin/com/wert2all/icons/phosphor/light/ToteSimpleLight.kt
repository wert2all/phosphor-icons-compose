...
val Phosphor.Light.ToteSimpleLight: ImageVector
    get() {
        if (_ToteSimpleLight != null) {
            return _ToteSimpleLight!!
        }
        _ToteSimpleLight =
            ImageVector
                .Builder(
                    name = "Light.ToteSimpleLight",
                    defaultWidth = 256.dp,
...
private var _ToteSimpleLight: ImageVector? = null
