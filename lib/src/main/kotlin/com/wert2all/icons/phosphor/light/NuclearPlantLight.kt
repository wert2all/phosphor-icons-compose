...
val Phosphor.Light.NuclearPlantLight: ImageVector
    get() {
        if (_NuclearPlantLight != null) {
            return _NuclearPlantLight!!
        }
        _NuclearPlantLight =
            ImageVector
                .Builder(
                    name = "Light.NuclearPlantLight",
                    defaultWidth = 256.dp,
...
private var _NuclearPlantLight: ImageVector? = null
