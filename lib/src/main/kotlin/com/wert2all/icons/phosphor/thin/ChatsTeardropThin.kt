...
val Phosphor.Thin.ChatsTeardropThin: ImageVector
    get() {
        if (_ChatsTeardropThin != null) {
            return _ChatsTeardropThin!!
        }
        _ChatsTeardropThin =
            ImageVector
                .Builder(
                    name = "Thin.ChatsTeardropThin",
                    defaultWidth = 256.dp,
...
private var _ChatsTeardropThin: ImageVector? = null
