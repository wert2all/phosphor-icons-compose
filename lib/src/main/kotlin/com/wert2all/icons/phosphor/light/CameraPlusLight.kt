...
val Phosphor.Light.CameraPlusLight: ImageVector
    get() {
        if (_CameraPlusLight != null) {
            return _CameraPlusLight!!
        }
        _CameraPlusLight =
            ImageVector
                .Builder(
                    name = "Light.CameraPlusLight",
                    defaultWidth = 256.dp,
...
private var _CameraPlusLight: ImageVector? = null
