...
val Phosphor.Light.HandFistLight: ImageVector
    get() {
        if (_HandFistLight != null) {
            return _HandFistLight!!
        }
        _HandFistLight =
            ImageVector
                .Builder(
                    name = "Light.HandFistLight",
                    defaultWidth = 256.dp,
...
private var _HandFistLight: ImageVector? = null
