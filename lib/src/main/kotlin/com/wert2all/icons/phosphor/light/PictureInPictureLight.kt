...
val Phosphor.Light.PictureInPictureLight: ImageVector
    get() {
        if (_PictureInPictureLight != null) {
            return _PictureInPictureLight!!
        }
        _PictureInPictureLight =
            ImageVector
                .Builder(
                    name = "Light.PictureInPictureLight",
                    defaultWidth = 256.dp,
...
private var _PictureInPictureLight: ImageVector? = null
