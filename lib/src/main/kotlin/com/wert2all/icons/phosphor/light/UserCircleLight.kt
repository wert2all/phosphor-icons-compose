...
val Phosphor.Light.UserCircleLight: ImageVector
    get() {
        if (_UserCircleLight != null) {
            return _UserCircleLight!!
        }
        _UserCircleLight =
            ImageVector
                .Builder(
                    name = "Light.UserCircleLight",
                    defaultWidth = 256.dp,
...
private var _UserCircleLight: ImageVector? = null
