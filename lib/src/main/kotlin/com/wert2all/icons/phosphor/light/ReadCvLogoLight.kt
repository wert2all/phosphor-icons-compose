...
val Phosphor.Light.ReadCvLogoLight: ImageVector
    get() {
        if (_ReadCvLogoLight != null) {
            return _ReadCvLogoLight!!
        }
        _ReadCvLogoLight =
            ImageVector
                .Builder(
                    name = "Light.ReadCvLogoLight",
                    defaultWidth = 256.dp,
...
private var _ReadCvLogoLight: ImageVector? = null
