...
val Phosphor.Duotone.ImageDuotone: ImageVector
    get() {
        if (_ImageDuotone != null) {
            return _ImageDuotone!!
        }
        _ImageDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.ImageDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = false, -8f, 8f)
                        verticalLineTo(168.69f)
                        lineToRelative(54.34f, -54.35f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 97.66f, 114.34f)
                        close()
                    }
                    path(
...
private var _ImageDuotone: ImageVector? = null
