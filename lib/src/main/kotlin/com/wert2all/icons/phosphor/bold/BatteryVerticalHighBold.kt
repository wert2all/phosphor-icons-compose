...
val Phosphor.Bold.BatteryVerticalHighBold: ImageVector
    get() {
        if (_BatteryVerticalHighBold != null) {
            return _BatteryVerticalHighBold!!
        }
        _BatteryVerticalHighBold =
            ImageVector
                .Builder(
                    name = "Bold.BatteryVerticalHighBold",
                    defaultWidth = 256.dp,
...
private var _BatteryVerticalHighBold: ImageVector? = null
