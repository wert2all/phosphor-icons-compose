...
val Duotone.EyedropperSampleDuotone: ImageVector
    get() {
        if (_EyedropperSampleDuotone != null) {
            return _EyedropperSampleDuotone!!
        }
        _EyedropperSampleDuotone =
            ImageVector
                .Builder(
                    name = "EyedropperSampleDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(49.67f, 186.24f)
                        horizontalLineToRelative(0f)
                        lineTo(40.48f, 207.3f)
                        arcToRelative(5.74f, 5.74f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.2f, 6.36f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8.86f, 1.67f)
                        lineToRelative(20f, -8.74f)
                        horizontalLineToRelative(0f)
                        arcToRelative(32f, 32f, 0f, isMoreThanHalf = false, isPositiveArc = false, 32.06f, -8f)
                        lineTo(141.25f, 160f)
                        horizontalLineTo(52.3f)
                        arcTo(32.07f, 32.07f, 0f, isMoreThanHalf = false, isPositiveArc = false, 49.67f, 186.24f)
                        close()
                    }
                    path(
...
private var _EyedropperSampleDuotone: ImageVector? = null
