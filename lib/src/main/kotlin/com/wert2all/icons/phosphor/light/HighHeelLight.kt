...
val Phosphor.Light.HighHeelLight: ImageVector
    get() {
        if (_HighHeelLight != null) {
            return _HighHeelLight!!
        }
        _HighHeelLight =
            ImageVector
                .Builder(
                    name = "Light.HighHeelLight",
                    defaultWidth = 256.dp,
...
private var _HighHeelLight: ImageVector? = null
