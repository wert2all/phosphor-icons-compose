...
val Phosphor.Thin.BasketballThin: ImageVector
    get() {
        if (_BasketballThin != null) {
            return _BasketballThin!!
        }
        _BasketballThin =
            ImageVector
                .Builder(
                    name = "Thin.BasketballThin",
                    defaultWidth = 256.dp,
...
private var _BasketballThin: ImageVector? = null
