...
val Phosphor.Light.RocketLaunchLight: ImageVector
    get() {
        if (_RocketLaunchLight != null) {
            return _RocketLaunchLight!!
        }
        _RocketLaunchLight =
            ImageVector
                .Builder(
                    name = "Light.RocketLaunchLight",
                    defaultWidth = 256.dp,
...
private var _RocketLaunchLight: ImageVector? = null
