...
val Phosphor.Duotone.AddressBookDuotone: ImageVector
    get() {
        if (_AddressBookDuotone != null) {
            return _AddressBookDuotone!!
        }
        _AddressBookDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.AddressBookDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcTo(32f, 32f, 0f, isMoreThanHalf = false, isPositiveArc = true, 136f, 144f)
                        close()
                    }
                    path(
...
private var _AddressBookDuotone: ImageVector? = null
