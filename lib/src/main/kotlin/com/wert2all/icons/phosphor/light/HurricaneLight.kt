...
val Phosphor.Light.HurricaneLight: ImageVector
    get() {
        if (_HurricaneLight != null) {
            return _HurricaneLight!!
        }
        _HurricaneLight =
            ImageVector
                .Builder(
                    name = "Light.HurricaneLight",
                    defaultWidth = 256.dp,
...
private var _HurricaneLight: ImageVector? = null
