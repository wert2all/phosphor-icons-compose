...
val Phosphor.Light.LighthouseLight: ImageVector
    get() {
        if (_LighthouseLight != null) {
            return _LighthouseLight!!
        }
        _LighthouseLight =
            ImageVector
                .Builder(
                    name = "Light.LighthouseLight",
                    defaultWidth = 256.dp,
...
private var _LighthouseLight: ImageVector? = null
