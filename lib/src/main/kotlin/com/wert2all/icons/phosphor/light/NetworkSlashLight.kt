...
val Phosphor.Light.NetworkSlashLight: ImageVector
    get() {
        if (_NetworkSlashLight != null) {
            return _NetworkSlashLight!!
        }
        _NetworkSlashLight =
            ImageVector
                .Builder(
                    name = "Light.NetworkSlashLight",
                    defaultWidth = 256.dp,
...
private var _NetworkSlashLight: ImageVector? = null
