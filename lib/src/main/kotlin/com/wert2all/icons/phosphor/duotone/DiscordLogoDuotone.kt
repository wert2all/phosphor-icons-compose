...
val Phosphor.Duotone.DiscordLogoDuotone: ImageVector
    get() {
        if (_DiscordLogoDuotone != null) {
            return _DiscordLogoDuotone!!
        }
        _DiscordLogoDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.DiscordLogoDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(147f, 183.06f)
                        arcToRelative(190.5f, 190.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -19f, 0.94f)
                        arcToRelative(190.5f, 190.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -19f, -0.94f)
                        lineTo(98.75f, 210.73f)
                        ...
                        lineTo(45.77f, 60f)
                        arcTo(8.08f, 8.08f, 0f, isMoreThanHalf = false, isPositiveArc = true, 52.31f, 54f)
                        ...
                        arcToRelative(192.32f, 192.32f, 0f, isMoreThanHalf = false, isPositiveArc = true, 50.88f, 0f)
                        lineToRelative(5f, -19.63f)
                        arcToRelative(8.1f, 8.1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 9.21f, -6f)
                        lineTo(203.69f, 54f)
...
private var _DiscordLogoDuotone: ImageVector? = null
