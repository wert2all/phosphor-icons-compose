...
val Phosphor.Light.PhoneOutgoingLight: ImageVector
    get() {
        if (_PhoneOutgoingLight != null) {
            return _PhoneOutgoingLight!!
        }
        _PhoneOutgoingLight =
            ImageVector
                .Builder(
                    name = "Light.PhoneOutgoingLight",
                    defaultWidth = 256.dp,
...
private var _PhoneOutgoingLight: ImageVector? = null
