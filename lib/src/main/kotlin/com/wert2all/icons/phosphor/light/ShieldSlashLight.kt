...
val Light.ShieldSlashLight: ImageVector
    get() {
        if (_ShieldSlashLight != null) {
            return _ShieldSlashLight!!
        }
        _ShieldSlashLight =
            ImageVector
                .Builder(
                    name = "ShieldSlashLight",
                    defaultWidth = 256.dp,
...
private var _ShieldSlashLight: ImageVector? = null
