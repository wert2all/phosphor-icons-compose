...
val Phosphor.Light.CalendarCheckLight: ImageVector
    get() {
        if (_CalendarCheckLight != null) {
            return _CalendarCheckLight!!
        }
        _CalendarCheckLight =
            ImageVector
                .Builder(
                    name = "Light.CalendarCheckLight",
                    defaultWidth = 256.dp,
...
private var _CalendarCheckLight: ImageVector? = null
