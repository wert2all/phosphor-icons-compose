...
val Phosphor.Thin.FolderSimpleThin: ImageVector
    get() {
        if (_FolderSimpleThin != null) {
            return _FolderSimpleThin!!
        }
        _FolderSimpleThin =
            ImageVector
                .Builder(
                    name = "Thin.FolderSimpleThin",
                    defaultWidth = 256.dp,
...
private var _FolderSimpleThin: ImageVector? = null
