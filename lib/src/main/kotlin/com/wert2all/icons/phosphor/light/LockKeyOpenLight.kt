...
val Phosphor.Light.LockKeyOpenLight: ImageVector
    get() {
        if (_LockKeyOpenLight != null) {
            return _LockKeyOpenLight!!
        }
        _LockKeyOpenLight =
            ImageVector
                .Builder(
                    name = "Light.LockKeyOpenLight",
                    defaultWidth = 256.dp,
...
private var _LockKeyOpenLight: ImageVector? = null
