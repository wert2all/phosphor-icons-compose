...
val Phosphor.Bold.VignetteBold: ImageVector
    get() {
        if (_VignetteBold != null) {
            return _VignetteBold!!
        }
        _VignetteBold =
            ImageVector
                .Builder(
                    name = "Bold.VignetteBold",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(72f, 128f)
                        arcToRelative(56f, 40f, 0f, isMoreThanHalf = true, isPositiveArc = false, 112f, 0f)
                        arcToRelative(56f, 40f, 0f, isMoreThanHalf = true, isPositiveArc = false, -112f, 0f)
                        close()
                    }
                }.build()
...
private var _VignetteBold: ImageVector? = null
