...
val Phosphor.Duotone.ImagesSquareDuotone: ImageVector
    get() {
        if (_ImagesSquareDuotone != null) {
            return _ImagesSquareDuotone!!
        }
        _ImagesSquareDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.ImagesSquareDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcTo(16f, 16f, 0f, isMoreThanHalf = false, isPositiveArc = true, 120f, 104f)
                        close()
                    }
                    path(
...
private var _ImagesSquareDuotone: ImageVector? = null
