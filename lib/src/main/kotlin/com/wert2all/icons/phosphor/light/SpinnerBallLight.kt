...
val Phosphor.Light.SpinnerBallLight: ImageVector
    get() {
        if (_SpinnerBallLight != null) {
            return _SpinnerBallLight!!
        }
        _SpinnerBallLight =
            ImageVector
                .Builder(
                    name = "Light.SpinnerBallLight",
                    defaultWidth = 256.dp,
...
private var _SpinnerBallLight: ImageVector? = null
