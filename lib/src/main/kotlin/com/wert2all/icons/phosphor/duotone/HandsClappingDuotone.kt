...
val Phosphor.Duotone.HandsClappingDuotone: ImageVector
    get() {
        if (_HandsClappingDuotone != null) {
            return _HandsClappingDuotone!!
        }
        _HandsClappingDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.HandsClappingDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(209.72f, 101.57f)
                        lineTo(188.61f, 65f)
                        arcToRelative(18f, 18f, 0f, isMoreThanHalf = false, isPositiveArc = false, -31.2f, 18f)
                        lineTo(133.18f, 41f)
                        arcTo(18f, 18f, 0f, isMoreThanHalf = true, isPositiveArc = false, 102f, 59f)
                        lineTo(96.28f, 49f)
                        arcTo(18f, 18f, 0f, isMoreThanHalf = true, isPositiveArc = false, 65.1f, 67f)
                        lineTo(77.81f, 89f)
                        lineToRelative(5.73f, 10f)
                        arcToRelative(18f, 18f, 0f, isMoreThanHalf = true, isPositiveArc = true, 31.17f, -18f)
                        lineToRelative(23.88f, 41.26f)
                        arcTo(18f, 18f, 0f, isMoreThanHalf = false, isPositiveArc = true, 170.14f, 105f)
                        lineToRelative(20.2f, 35f)
                        arcTo(71.67f, 71.67f, 0f, isMoreThanHalf = false, isPositiveArc = true, 199f, 187.75f)
                        horizontalLineToRelative(0f)
                        arcTo(72f, 72f, 0f, isMoreThanHalf = false, isPositiveArc = false, 209.72f, 101.57f)
                        close()
                    }
                    path(
...
private var _HandsClappingDuotone: ImageVector? = null
