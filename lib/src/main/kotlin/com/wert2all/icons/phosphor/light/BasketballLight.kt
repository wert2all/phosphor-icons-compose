...
val Phosphor.Light.BasketballLight: ImageVector
    get() {
        if (_BasketballLight != null) {
            return _BasketballLight!!
        }
        _BasketballLight =
            ImageVector
                .Builder(
                    name = "Light.BasketballLight",
                    defaultWidth = 256.dp,
...
private var _BasketballLight: ImageVector? = null
