...
val Phosphor.Light.BatteryFullLight: ImageVector
    get() {
        if (_BatteryFullLight != null) {
            return _BatteryFullLight!!
        }
        _BatteryFullLight =
            ImageVector
                .Builder(
                    name = "Light.BatteryFullLight",
                    defaultWidth = 256.dp,
...
private var _BatteryFullLight: ImageVector? = null
