...
val Phosphor.Bold.FlyingSaucerBold: ImageVector
    get() {
        if (_FlyingSaucerBold != null) {
            return _FlyingSaucerBold!!
        }
        _FlyingSaucerBold =
            ImageVector
                .Builder(
                    name = "Bold.FlyingSaucerBold",
                    defaultWidth = 256.dp,
...
private var _FlyingSaucerBold: ImageVector? = null
