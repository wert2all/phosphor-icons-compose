...
val Phosphor.Light.CloudSunLight: ImageVector
    get() {
        if (_CloudSunLight != null) {
            return _CloudSunLight!!
        }
        _CloudSunLight =
            ImageVector
                .Builder(
                    name = "Light.CloudSunLight",
                    defaultWidth = 256.dp,
...
private var _CloudSunLight: ImageVector? = null
