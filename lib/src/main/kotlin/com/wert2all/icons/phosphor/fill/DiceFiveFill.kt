...
val Phosphor.Fill.DiceFiveFill: ImageVector
    get() {
        if (_DiceFiveFill != null) {
            return _DiceFiveFill!!
        }
        _DiceFiveFill =
            ImageVector
                .Builder(
                    name = "Fill.DiceFiveFill",
                    defaultWidth = 256.dp,
                    ...
                    path(fill = SolidColor(Color.Black)) {
                        ...
                        arcTo(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, 92f, 176f)
                        close()
                        moveTo(92f, 104f)
                        arcToRelative(12f, 12f, 0f, isMoreThanHalf = true, isPositiveArc = true, 12f, -12f)
                        ...
                        moveTo(164f, 104f)
                        arcToRelative(12f, 12f, 0f, isMoreThanHalf = true, isPositiveArc = true, 12f, -12f)
                        arcTo(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, 164f, 104f)
                        close()
                    }
                }.build()
...
private var _DiceFiveFill: ImageVector? = null
