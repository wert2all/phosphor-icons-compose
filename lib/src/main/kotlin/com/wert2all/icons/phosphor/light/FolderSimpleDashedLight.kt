...
val Phosphor.Light.FolderSimpleDashedLight: ImageVector
    get() {
        if (_FolderSimpleDashedLight != null) {
            return _FolderSimpleDashedLight!!
        }
        _FolderSimpleDashedLight =
            ImageVector
                .Builder(
                    name = "Light.FolderSimpleDashedLight",
                    defaultWidth = 256.dp,
...
private var _FolderSimpleDashedLight: ImageVector? = null
