...
val Phosphor.Duotone.GlobeHemisphereEastDuotone: ImageVector
    get() {
        if (_GlobeHemisphereEastDuotone != null) {
            return _GlobeHemisphereEastDuotone!!
        }
        _GlobeHemisphereEastDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.GlobeHemisphereEastDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(215f, 168.71f)
                        arcToRelative(96.42f, 96.42f, 0f, isMoreThanHalf = false, isPositiveArc = true, -30.54f, 37f)
                    ...
                    path(
                        ...
                        moveTo(184f, 74f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.94f, 5.22f)
                        lineTo(159.89f, 105f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, -5f, 2.71f)
                        lineToRelative(-31.46f, 4.26f)
                        arcToRelative(8.06f, 8.06f, 0f, isMoreThanHalf = false, isPositiveArc = true, -5.77f, -1.45f)
                        lineToRelative(-19.81f, -13f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = false, -11.34f, 2f)
                        lineToRelative(-20.94f, 31.3f)
                        arcToRelative(8.06f, 8.06f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.35f, 4.41f)
                        lineTo(64f, 171.49f)
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, -3.61f, 6.64f)
                        lineToRelative(-9.92f, 6.52f)
                        arcTo(96f, 96f, 0f, isMoreThanHalf = false, isPositiveArc = true, 184f, 50f)
                        close()
                    }
                    path(
...
private var _GlobeHemisphereEastDuotone: ImageVector? = null
