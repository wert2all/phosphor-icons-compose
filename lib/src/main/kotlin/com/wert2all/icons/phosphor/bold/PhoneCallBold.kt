...
val Phosphor.Bold.PhoneCallBold: ImageVector
    get() {
        if (_PhoneCallBold != null) {
            return _PhoneCallBold!!
        }
        _PhoneCallBold =
            ImageVector
                .Builder(
                    name = "Bold.PhoneCallBold",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        moveTo(141.23f, 86f)
                        arcTo(44.11f, 44.11f, 0f, isMoreThanHalf = false, isPositiveArc = true, 170f, 114.77f)
                    }
                }.build()
...
private var _PhoneCallBold: ImageVector? = null
