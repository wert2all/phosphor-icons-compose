...
val Fill.FileArrowUpFill: ImageVector
    get() {
        if (_FileArrowUpFill != null) {
            return _FileArrowUpFill!!
        }
        _FileArrowUpFill =
            ImageVector
                .Builder(
                    ...
                    path(fill = SolidColor(Color(0xFF000000))) {
                        ...
                        arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 11.32f, 0f)
                        lineToRelative(24f, 24f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 157.66f, 149.66f)
                        close()
                        moveTo(152f, 88f)
                        lineTo(152f, 44f)
...
private var _FileArrowUpFill: ImageVector? = null
