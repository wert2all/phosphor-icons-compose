...
val Phosphor.Duotone.CircuitryDuotone: ImageVector
    get() {
        if (_CircuitryDuotone != null) {
            return _CircuitryDuotone!!
        }
        _CircuitryDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.CircuitryDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcTo(16f, 16f, 0f, isMoreThanHalf = false, isPositiveArc = true, 88f, 184f)
                        close()
                        moveTo(168f, 120f)
                        arcToRelative(16f, 16f, 0f, isMoreThanHalf = true, isPositiveArc = true, 16f, -16f)
                        arcTo(16f, 16f, 0f, isMoreThanHalf = false, isPositiveArc = true, 168f, 120f)
                        close()
                    }
                    path(
...
private var _CircuitryDuotone: ImageVector? = null
