...
val Phosphor.Duotone.SealQuestionDuotone: ImageVector
    get() {
        if (_SealQuestionDuotone != null) {
            return _SealQuestionDuotone!!
        }
        _SealQuestionDuotone =
            ImageVector
                .Builder(
                    name = "Duotone.SealQuestionDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        curveToRelative(17.67f, 0f, 32f, -12.54f, 32f, -28f)
                        reflectiveCurveToRelative(-14.33f, -28f, -32f, -28f)
                        reflectiveCurveTo(96f, 92.54f, 96f, 108f)
...
private var _SealQuestionDuotone: ImageVector? = null
