...
val Phosphor.Thin.BatteryEmptyThin: ImageVector
    get() {
        if (_BatteryEmptyThin != null) {
            return _BatteryEmptyThin!!
        }
        _BatteryEmptyThin =
            ImageVector
                .Builder(
                    name = "Thin.BatteryEmptyThin",
                    defaultWidth = 256.dp,
...
private var _BatteryEmptyThin: ImageVector? = null
