...
val Phosphor.Light.FolderSimplePlusLight: ImageVector
    get() {
        if (_FolderSimplePlusLight != null) {
            return _FolderSimplePlusLight!!
        }
        _FolderSimplePlusLight =
            ImageVector
                .Builder(
                    name = "Light.FolderSimplePlusLight",
                    defaultWidth = 256.dp,
...
private var _FolderSimplePlusLight: ImageVector? = null
