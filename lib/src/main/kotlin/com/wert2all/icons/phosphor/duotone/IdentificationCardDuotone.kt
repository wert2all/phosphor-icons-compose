...
val Duotone.IdentificationCardDuotone: ImageVector
    get() {
        if (_IdentificationCardDuotone != null) {
            return _IdentificationCardDuotone!!
        }
        _IdentificationCardDuotone =
            ImageVector
                .Builder(
                    name = "IdentificationCardDuotone",
                    defaultWidth = 256.dp,
                    ...
                    path(
                        ...
                        arcTo(24f, 24f, 0f, isMoreThanHalf = false, isPositiveArc = true, 96f, 144f)
                        close()
                    }
                    path(
                    ...
                    path(
                        ...
                        moveTo(64f, 168f)
                        curveToRelative(3.55f, -13.8f, 17.09f, -24f, 32f, -24f)
                        reflectiveCurveToRelative(28.46f, 10.19f, 32f, 24f)
                    }
                }.build()
...
private var _IdentificationCardDuotone: ImageVector? = null
