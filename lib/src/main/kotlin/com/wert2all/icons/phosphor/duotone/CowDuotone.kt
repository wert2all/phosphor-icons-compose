...
val Phosphor.Duotone.CowDuotone: ImageVector
    get() {
        if (_CowDuotone != null) {
            return _CowDuotone!!
        }
            ...
            ImageVector
                .Builder(
                    ...
                    path(
                        ...
                        moveTo(239.85f, 110.53f)
                        arcTo(48f, 48f, 0f, isMoreThanHalf = false, isPositiveArc = false, 192.78f, 72f)
                        horizontalLineTo(160f)
                        arcToRelative(32f, 32f, 0f, isMoreThanHalf = false, isPositiveArc = true, 32f, 32f)
                        verticalLineToRelative(16f)
                        horizontalLineToRelative(40f)
                        arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = false, 239.85f, 110.53f)
                        close()
                    }
                    path(
...
private var _CowDuotone: ImageVector? = null
