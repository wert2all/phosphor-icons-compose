...
val Phosphor.Light.TestTubeLight: ImageVector
    get() {
        if (_TestTubeLight != null) {
            return _TestTubeLight!!
        }
        _TestTubeLight =
            ImageVector
                .Builder(
                    name = "Light.TestTubeLight",
                    defaultWidth = 256.dp,
...
private var _TestTubeLight: ImageVector? = null
