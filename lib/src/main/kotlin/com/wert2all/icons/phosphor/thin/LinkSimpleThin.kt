...
val Phosphor.Thin.LinkSimpleThin: ImageVector
    get() {
        if (_LinkSimpleThin != null) {
            return _LinkSimpleThin!!
        }
        _LinkSimpleThin =
            ImageVector
                .Builder(
                    name = "Thin.LinkSimpleThin",
                    defaultWidth = 256.dp,
...
private var _LinkSimpleThin: ImageVector? = null
