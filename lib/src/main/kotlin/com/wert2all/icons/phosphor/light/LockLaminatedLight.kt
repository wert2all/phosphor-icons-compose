...
val Phosphor.Light.LockLaminatedLight: ImageVector
    get() {
        if (_LockLaminatedLight != null) {
            return _LockLaminatedLight!!
        }
        _LockLaminatedLight =
            ImageVector
                .Builder(
                    name = "Light.LockLaminatedLight",
                    defaultWidth = 256.dp,
...
private var _LockLaminatedLight: ImageVector? = null
